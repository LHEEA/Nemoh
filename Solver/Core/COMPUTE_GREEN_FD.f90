...
!-------------------------------------------------------------------------------!
      ...
      REAL:: ZL41,ZL51,ZL42,ZL43,ZL53,ZL531,ZL44,ZL54,ZL1,ZL3
...
!-------------------------------------------------------------------------------!
      ...
      REAL:: XL1,XL2,XL3,XL4,XL5,XPG,YPG,YMJJJ,ZL11,ZL12,ZL13,ZL14
      ...
      REAL:: ASA
      REAL :: ZL41,ZL51,ZL42,ZL52,ZL43,ZL53,ZL531,ZL44,ZL54,ZL1,ZL3
	...
	DO 7122 JJ=1,NJJ 
     ...
     DO 211 L=1,NG
      ...
      PSURR1=0.
      ENDIF
      IF(AKZ1.LT.-1.5E-10)THEN
      IF(AKZ1.GT.-251.)THEN  !0002B
      IF(AKR.LT.100)THEN !0003B
     ...
     XL3*APD2Z(KI  ,KJ1+2)+XL4*APD2Z(KI+1,KJ1+2)+XL5*APD2Z(KI+2,KJ1+2)
      ...
      PSURR2=0.
      ENDIF
      IF(AKZ2.LT.-1.5E-10)THEN
      IF(AKZ2.GT.-251.)THEN  !0002B
      IF(AKR.LT.100)THEN  !0003B
     ...
     XL3*APD2Z(KI  ,KJ2+2)+XL4*APD2Z(KI+1,KJ2+2)+XL5*APD2Z(KI+2,KJ2+2)
      ...
      IF(AKZ3.LT.-1.5E-10)THEN
      IF(AKZ3.GT.-251.)THEN  !0008B
      IF(AKR.LT.100)THEN  !0009B
     ...
     XL3*APD2Z(KI  ,KJ3+2)+XL4*APD2Z(KI+1,KJ3+2)+XL5*APD2Z(KI+2,KJ3+2)
      ...
      IF(AKZ4.LT.-1.5E-10)THEN
      IF(AKZ4.GT.-251.)THEN  !0011B
      IF(AKR.LT.100)THEN  !0012B
