...
!----------------------------------------------------------------
      ...
      INTEGER:: I,J,JJ,NJJ,BX,KI,KJ,LLL,IAS
      REAL:: XPO,YPO,ZPO,PL5,ZGAJ,ZER,TIRAN
...
!-------------------------------------------------------
      ...
      REAL:: FS1(NFA,2),FS2(NFA,2)    
      INTEGER::I,J,JJ,NJJ,NEXP,NEXP1,IAS1,IAS2,IAS3,IAS4
      INTEGER::KK(5),BX,KE,KI,KJ1,KJ2,KJ3,KJ4,L
      REAL::H,A,AKH,AMH,COE3,COE4,EPS,ZERG,ZGAJ,ZER,TIRAN
