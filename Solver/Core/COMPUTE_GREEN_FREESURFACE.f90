...
!----------------------------------------------------------------
      ...
      INTEGER:: J,JJ,NJJ,BX,KI,KJ,LLL
      REAL:: XPO,YPO,ZPO,PL5
...
!-------------------------------------------------------
      ...
      REAL::H,A,AKH,AMH,COE3,COE4,EPS,ZERG
      ...
      REAL:: EPZ1,EPZ2,EPZ3,EPZ4,FTS1,FTS2,FTS3,FTS4
      ...
      PL5(U1,U2,U3,U4,U5,XU)=((XU-U1)*(XU-U2)*(XU-U3)*(XU-U4))/((U5-U1)&
      *(U5-U2)*(U5-U3)*(U5-U4))
      PI4=ATAN(1.)
      PI=4.*ATAN(1.)                                                             
      DPI=2.*PI
