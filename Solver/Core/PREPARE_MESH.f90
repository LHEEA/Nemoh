...
!~ C
    INQUIRE(FILE='GREN.QAT',EXIST=FICHEX)
       print *,'gren.qat ',fichex
    IF(.NOT.FICHEX)THEN
    CALL CREK
     OPEN(UNIT=44,FILE='GREN.QAT',FORM='UNFORMATTED',STATUS='NEW')
     ...
     (APD2X(I,J),I=1,IIR),(APD2Z(I,J),I=1,IIR)
      ...
      ENDDO
      ELSE
     OPEN(UNIT=44,FILE='GREN.QAT',FORM='UNFORMATTED',STATUS='OLD')
