MODULE SOLVE_BEM_INFD_ITERATIVE
  ...
  CONTAINS
!--------------------------------------------------------------------------!
  SUBROUTINE SOLVE_POTENTIAL_INFD_ITERATIVE(LWORK,WORK,NVEL)

    COMPLEX,DIMENSION(*) :: NVEL
    INTEGER:: LWORK
    COMPLEX:: WORK(LWORK)
    INTEGER :: BX,ISYM,NJJ,N
    INTEGER ::I,J,NP1,I1,JJ
    REAL:: W,tdepth,BJ,GM,DIJ,AKK
!   REAL:: CB,SB,CP,CR,COEFB,COEFS,BETA,SD1B,SD1S,SD2B,SD2S,AKAD,
