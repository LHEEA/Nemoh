...
gfortran -c Solver/Core/FIC_COM.f90
...
gfortran -c -ffree-line-length-none Common/Results.f90
gfortran -c postProcessor/Compute_RAOs.f90
gfortran -c -ffree-line-length-none postProcessor/IRF.f90
gfortran -c -ffree-line-length-none postProcessor/Plot_WaveElevation.f90
gfortran -c -cpp -DGNUFORT -ffree-line-length-none postProcessor/Main.f90

gfortran Identification.o Environment.o Results.o Mesh.o Compute_RAOs.o IRF.o Plot_WaveElevation.o Main.o -o nemoh_postproc
