...
rm *.o
rm *.mod
#~ mv nemoh_preproc Verification/Cylinder
...
# Linker
gfortran Mesh.o Identification.o Bodyconditions.o COM_VAR.o OUTPUT.o ELEMENTARY_FNS.o \
COMPUTE_GREEN_INFD.o M_SOLVER.o SOLVE_BEM_INFD_DIRECT.o COMPUTE_GREEN_FD.o \
SOLVE_BEM_FD_DIRECT.o SOLVE_BEM.o PREPARE_MESH.o INITIALIZATION.o ALLOCATE_DATA.o \
COMPUTE_KOCHIN.o COMPUTE_GREEN_FREESURFACE.o COMPUTE_POTENTIAL_DOMAIN.o DEALLOCATE_DATA.o NEMOH.o \
-o nemoh
